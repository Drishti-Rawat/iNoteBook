...
const NoteCard = ({note,handledelete,handleEdit}) => {
  ...
  return (
    <div className=' relative flex flex-col overflow-hidden  bg-neutral-100 rounded-lg shadow-lg shadow-gray-500  w-[400px] '>

       

            <div className='flex justify-between items-center text-sm  bg-gray-200 py-3 px-3 '>
            ...
            <div className='px-4 text-sm text-wrap   py-3  '>
